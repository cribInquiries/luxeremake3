...
export function ClearviewTransformationView({ property }: ClearviewTransformationViewProps) {
  ...
  const galleryImages = [
    ...
    { src: "/images/cbedroom1new.jpeg", alt: "Bright modern bedroom with white marble flooring" },
    { src: "/images/cbedroom2new.jpeg", alt: "Sophisticated bedroom with black furniture" },
  ]
